...
test('1.7_object_storage_이벤트관리', async ({ page }) => {
  ...
  // await page.getByText('Cloud Functions', { exact: true }).click();
  await page.locator('#mCSB_8_container').getByText('Cloud Functions').click();
...
test ('3.1_object_storage_수명주기설정', async ({page}) => {
  ...
  await page.locator('#mCSB_4_container').getByText(bucketname).click();
